...
// ── Helpers to Hydrate Raw Mongo IDs for Frontend Components ──
...
export async function fetchDashboardStats(user) {
  try {
    ...
    // If personal scope is needed for employee views
    if (isEmployee) {
    ...
    // Fallback counts so page renders during network transit
    return {
...
export async function createProject({
  ...
  // Re-fetch users and teams to return hydrated object for direct state updates
